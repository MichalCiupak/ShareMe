...
const isNotActiveStyle = 'flex items-center px-5 gap-3 test-gray-500 hover:text-black transition-all duratin-200 ease-in-out capitalize';
const isActiveStyle = 'flex items-center px-5 gap-3 font-extrabold border-r-2 border-black transition-all duratin-200 ease-in-out capitalize';
